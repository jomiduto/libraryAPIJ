...
@section('title', 'Contenidos Biblioteca AIPJ | Asociación Iberoamericana de Psicología Jurídica')
...
@section('content')
    ...
    <section class="<section class="mb-8"></section>
        ...
        <div>
            <h1 class="font-sora text-primary font-bold text-6xl mb-3">Aquí va la tabla</h1>
        </div>
    </section>
@endsection
